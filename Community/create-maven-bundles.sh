...
jar -cvf Payara-EJB-HTTP-Client.jar -C Payara-EJB-HTTP-Client ejb-http-client-${RELEASE_VERSION}.jar -C Payara-EJB-HTTP-Client ejb-http-client-${RELEASE_VERSION}.jar.asc -C Payara-EJB-HTTP-Client ejb-http-client-${RELEASE_VERSION}-sources.jar -C Payara-EJB-HTTP-Client ejb-http-client-${RELEASE_VERSION}-sources.jar.asc -C Payara-EJB-HTTP-Client ejb-http-client-${RELEASE_VERSION}-javadoc.jar -C Payara-EJB-HTTP-Client ejb-http-client-${RELEASE_VERSION}-javadoc.jar.asc -C Payara-EJB-HTTP-Client ejb-http-client-${RELEASE_VERSION}.pom -C Payara-EJB-HTTP-Client ejb-http-client-${RELEASE_VERSION}.pom.asc
