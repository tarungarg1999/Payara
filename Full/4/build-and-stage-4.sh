...
git branch -D CUSTCOM-${JIRA_NUMBER}-Increment-Version-Numbers-4.${NEXT_MINOR_VERSION}
git checkout Payara4
git checkout -b CUSTCOM-${JIRA_NUMBER}-Increment-Version-Numbers-4.${NEXT_MINOR_VERSION}
...
git push ${GITHUB_REMOTE} CUSTCOM-${JIRA_NUMBER}-Increment-Version-Numbers-4.${NEXT_MINOR_VERSION} --force
