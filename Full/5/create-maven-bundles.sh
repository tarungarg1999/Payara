...
gpg2 -ab Payara-Appclient/payara-client-${VERSION}.pom
gpg2 -ab Payara-Appclient/payara-client-${VERSION}.jar
gpg2 -ab Payara-Appclient/payara-client-${VERSION}-sources.jar
gpg2 -ab Payara-Appclient/payara-client-${VERSION}-javadoc.jar
...
jar -cvf Payara-Appclient/bundle.jar -C Payara-Appclient payara-client-${VERSION}.jar -C Payara-Appclient payara-client-${VERSION}.jar.asc -C Payara-Appclient payara-client-${VERSION}-sources.jar -C Payara-Appclient payara-client-${VERSION}-sources.jar.asc -C Payara-Appclient payara-client-${VERSION}-javadoc.jar -C Payara-Appclient payara-client-${VERSION}-javadoc.jar.asc -C Payara-Appclient payara-client-${VERSION}.pom -C Payara-Appclient payara-client-${VERSION}.pom.asc
