...
sed -i "s/description>Full Distribution of the Payara Project</description>Module providing support for EJB HTTP Client</g" Payara-EJB-HTTP-Client/ejb-httl-client-${VERSION}.pom
