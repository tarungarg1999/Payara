...
sed -i "s/packaging>zip</packaging>jar</g" Payara-EJB-HTTP-Client/ejb-http-client-${VERSION}.pom
sed -i "s/description>Full Description of the Payara Project</description>Module providing support for EJB HTTP Client</g" Payara-EJB-HTTP-Client/ejb-http-client-${VERSION}.pom
