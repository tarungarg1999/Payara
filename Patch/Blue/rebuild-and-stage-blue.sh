...
cp ${REPO_DIR}/target/payara-${VERSION}-javadoc.jar Payara-Blue/payara-${VERSION}-javadoc.jar
cp ${REPO_DIR}/target/payara-${VERSION}-javadoc.jar Payara-Blue-ML/payara-ml-${VERSION}-javadoc.jar
cp ${REPO_DIR}/target/payara-${VERSION}-javadoc.jar Payara-Blue-Web/payara-web-${VERSION}-javadoc.jar
cp ${REPO_DIR}/target/payara-${VERSION}-javadoc.jar Payara-Blue-Web-ML/payara-web-ml-${VERSION}-javadoc.jar
cp ${REPO_DIR}/target/payara-${VERSION}-javadoc.jar Payara-Blue-Micro/payara-micro-${VERSION}-javadoc.jar
cp ${REPO_DIR}/target/payara-${VERSION}-javadoc.jar Payara-Blue-Embedded-All/payara-embedded-all-${VERSION}-javadoc.jar
cp ${REPO_DIR}/target/payara-${VERSION}-javadoc.jar Payara-Blue-Embedded-Web/payara-embedded-web-${VERSION}-javadoc.jar
...
sed -i "s/groupId>fish.payara.distributions</groupId>fish.payara.blue.distributions</g" Payara-Blue-ML/payara-${VERSION}.pom
...
sed -i "s/groupId>fish.payara.distributions</groupId>fish.payara.blue.distributions</g" Payara-Blue-Web/payara-${VERSION}.pom
...
sed -i "s/groupId>fish.payara.distributions</groupId>fish.payara.blue.distributions</g" Payara-Blue-Web-ML/payara-${VERSION}.pom
...
MAVEN_OPTS="-Xmx2G -XX:MaxPermSize=512m -Djavax.net.ssl.trustStore=${JAVA_HOME}/jre/lib/security/cacerts" mvn clean install -PBuildExtras -Dbuild.number=${BUILD_NUMBER} -U
...
mvn deploy:deploy-file -Dversion=${VERSION}.RC${RC_VERSION} -Dfile=Payara-Blue-Web/payara-web-${VERSION}.zip -Dsources=Payara-Blue-Web/payara-web-${VERSION}-sources.jar -Djavadoc=Payara-Blue-Web/payara-web-${VERSION}-javadoc.jar -DpomFile=Payara-Blue-Web/payara-web-${VERSION}.pom -DrepositoryId=payara-nexus -Durl=https://nexus.payara.fish/content/repositories/payara-staging/ -Djavax.net.ssl.trustStore=/tmp/mavenKeystore
...
mvn deploy:deploy-file -Dversion=${VERSION}.RC${RC_VERSION} -Dfile=Payara-Blue-Micro/payara-micro-${VERSION}.jar -Dsources=Payara-Blue-Micro/payara-micro-${VERSION}-sources.jar -Djavadoc=Payara-Blue-Micro/payara-micro-${VERSION}-javadoc.jar -DpomFile=Payara-Blue-Micro/payara-micro-${VERSION}.pom -DrepositoryId=payara-nexus -Durl=https://nexus.payara.fish/content/repositories/payara-staging/ -Djavax.net.ssl.trustStore=/tmp/mavenKeystore
...
mvn deploy:deploy-file -Dversion=${VERSION}.RC${RC_VERSION} -Dfile=Payara-Blue-Embedded-All/payara-embedded-all-${VERSION}.jar -Dsources=Payara-Blue-Embedded-All/payara-embedded-all-${VERSION}-sources.jar -Djavadoc=Payara-Blue-Embedded-All/payara-embedded-all-${VERSION}-javadoc.jar -DpomFile=Payara-Blue-Embedded-All/payara-embedded-all-${VERSION}.pom -DrepositoryId=payara-nexus -Durl=https://nexus.payara.fish/content/repositories/payara-staging/ -Djavax.net.ssl.trustStore=/tmp/mavenKeystore
...
mvn deploy:deploy-file -Dversion=${VERSION}.RC${RC_VERSION} -Dfile=Payara-Blue-Embedded-Web/payara-embedded-web-${VERSION}.jar -Dsources=Payara-Blue-Embedded-Web/payara-embedded-web-${VERSION}-sources.jar -Djavadoc=Payara-Blue-Embedded-Web/payara-embedded-web-${VERSION}-javadoc.jar -DpomFile=Payara-Blue-Embedded-Web/payara-embedded-web-${VERSION}.pom -DrepositoryId=payara-nexus -Durl=https://nexus.payara.fish/content/repositories/payara-staging/ -Djavax.net.ssl.trustStore=/tmp/mavenKeystore
