...
sed -i "s/update_version>${CURRENT_UPDATE_VERSION}</update_version>${RELEASE_UPDATE_VERSION}</g" appserver/pom.xml
sed -i "s/update_version=${CURRENT_UPDATE_VERSION}/update_version=${RELEASE_UPDATE_VERSION}/g" appserver/extras/payara-micro/payara-micro-boot/src/main/resources/MICRO-INF/domain/branding/glassfish-version.properties
