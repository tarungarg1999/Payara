...
mvn deploy:deploy-file -Dfile=Payara-API/payara-api-${RELEASE_VERSION}.jar -DpomFile=Payara-API/payara-api-${RELEASE_VERSION}.pom -DrepositoryId=payara-nexus -Durl=https://nexus.payara.fish/content/repositories/payara-patches/ -Djavax.net.ssl.trustStore=${JDK8_PATH}/jre/lib/security/cacerts -Dsources=Payara-API/payara-api-${RELEASE_VERSION}-sources.jar -Djavadoc=Payara-API/payara-api-${RELEASE_VERSION}-javadoc.jar

mvn deploy:deploy-file -Dfile=Payara-EJB-HTTP-Client/ejb-http-client-${RELEASE_VERSION}.jar -DpomFile=Payara-EJB-HTTP-Client/ejb-http-client-${RELEASE_VERSION}.pom -DrepositoryId=payara-nexus -Durl=https://nexus.payara.fish/content/repositories/payara-patches/ -Djavax.net.ssl.trustStore=${JDK8_PATH}/jre/lib/security/cacerts -Dsources=Payara-EJB-HTTP-Client/ejb-http-client-${RELEASE_VERSION}-sources.jar -Djavadoc=Payara-EJB-HTTP-Client/ejb-http-client-${RELEASE_VERSION}-javadoc.jar

mvn deploy:deploy-file -Dversion=${RELEASE_VERSION} -Dfile=Payara-Appclient/payara-client-${RELEASE_VERSION}.jar -DpomFile=Payara-Appclient/payara-client-${RELEASE_VERSION}.pom -DrepositoryId=payara-nexus -Durl=https://nexus.payara.fish/content/repositories/payara-patches/ -Djavax.net.ssl.trustStore=${JDK8_PATH}/jre/lib/security/cacerts -Dsources=Payara-Appclient/payara-client-${RELEASE_VERSION}-sources.jar -Djavadoc=Payara-Appclient/payara-client-${RELEASE_VERSION}-javadoc.jar

mvn deploy:deploy-file -Dversion=${RELEASE_VERSION} -DpomFile=Payara-BOM/payara-bom-${RELEASE_VERSION}.pom -Dfile=Payara-BOM/payara-bom-${RELEASE_VERSION}.pom -DrepositoryId=payara-nexus -Durl=https://nexus.payara.fish/content/repositories/payara-patches/ -Djavax.net.ssl.trustStore=${JDK8_PATH}/jre/lib/security/cacerts
